...
public class GUIAspectGenerator extends GuiIC2 {
    public final ContainerAspectGenerator container;

    public GUIAspectGenerator(ContainerAspectGenerator container1) {
        super(container1);
